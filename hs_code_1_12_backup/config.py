...
# LLM 설정
LLM_MODEL_NAME = get_conf("llm.model_name", "LGAI-EXAONE/EXAONE-4.0-32B-AWQ")
ENABLE_REASONING = get_conf("llm.enable_reasoning", True)
# [최적화] Max Tokens를 32k에서 8k로 하향 조정하여 속도 개선
MAX_TOKENS = int(get_conf("llm.max_tokens", 8192))
